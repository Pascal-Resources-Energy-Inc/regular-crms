          ...
          <div class="row">
            <div class="col-md-12">
              <div class="mb-3">
                ...
                <input type="text" class="form-control required" id="wfirstName2" name="name" required data-uppercase>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control required" id="wphoneNumber2" maxlength="11" pattern="\d{11}" name="phone_number" required oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 11);" data-uppercase>
              </div>
            </div>
            <div class="col-md-12">
              <div class="mb-3">
                <label class="form-label" for="facebook2">Facebook <span class="text-danger">*</span></label>
                <input type="tel" class="form-control required" id="facebook2" name='facebook' required data-uppercase>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="mb-3">
                ...
                <textarea class="form-control required" name='address' required data-uppercase></textarea>
              </div>
            </div>
...
<script>
  document.addEventListener('input', function (event) {
    ...
    if (!field.matches('input[data-uppercase], textarea[data-uppercase]')) {
      return;
    }
    ...
    if (start !== null && end !== null && typeof field.setSelectionRange === 'function') {
